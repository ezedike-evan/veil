...
// ── useInactivityLock ─────────────────────────────────────────────────────────
/**
 * Tracks user inactivity on window events and redirects to /lock when the
 * user has been idle for LOCK_TIMEOUT_MS.
 *
 * Uses refs for both the timer ID and last-activity timestamp to avoid
 * causing re-renders on every mouse move or keypress.
 */
